    ...
    <div className="flex flex-col space-y-8 justify-center items-center min-h-screen">
      ...
      <Panel className='flex flex-col space-y-8'>
        ...
        <div className='flex flex-col space-y-4'>
          ...
          <input value={sentenceCount || ''} onChange={handleSentenceCountChange} type="number" className="py-1 my-3 bg-gray-50 border border-gray-300"/>
        </div>
        <div className='flex flex-col space-y-4'>
        ...
        <div className='flex flex-col space-y-4'>
          <label>Input</label>
          <textarea rows="5" value={input} onChange={handleInputChange} className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"/>
        </div>
        <div className='flex space-x-4'>
          <Button warning rounded outline className='text-yellow-600' onClick={handleClear}>Clear</Button>
          <Button success rounded outline onClick={handleSubmit}>{loading ? <>Loading..</> : <>Submit</>}</Button>
        </div>
        <div className='flex flex-col space-y-4'>
          <label>Example</label>
        ...
        <div className='flex flex-col space-y-4'>
          <label>Output</label>
          <textarea rows="10" value={output} onChange={handleOutputChange} className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"/>
        </div>
      </Panel>
    </div>
  ) 
